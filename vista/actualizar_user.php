...
<body>
    ...
    <form class="container-table container-table--edit" action="../modelo/procesar_actualizar_user.php" method="post">
        <div class="table__title  table__title--edit">Edición de Usuario</div>
        ...
        <input type="hidde" class="table__input" value="<?php echo $row["id_usuario"];?>" name="id"> 
        <input type="text" class="table__input" value="<?php echo $row["clave"];?>" name="clave">
        <input type="text" class="table__input" value="<?php echo $row["rol_id"];?>" name="rol">
