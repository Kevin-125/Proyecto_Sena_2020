...
<font size=3>
	...
	<a href="../vista/clienete.php" style="font-size: 1.5rem" class="btn btn-primary">CREAR USUARIO </a>
	<a href="../vista/edicion_user.php" style="font-size: 1.5rem" class="btn btn-success">EDITAR DATOS</a>
