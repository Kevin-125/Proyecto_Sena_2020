    ...
    <table id="tablax" class="table table-striped table-bordered" style="width:100%">
        ...
        while($row= mysqli_fetch_assoc($resultado)) { ?>
            <tr>
				...
				<td>
        <a href="../vista/actualizar_user.php? id_usuario=<?php echo $row["id_usuario"];?>" class="btn btn-primary">Editar</a> |
		<a href="../modelo/procesareliminaruser.php? id_usuario=<?php echo $row["id_usuario"];?>" class="btn btn-danger" onclick="return confirmar()">Eliminar</a>
