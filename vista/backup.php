...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
              <h1 class="text-titles"><i class="zmdi zmdi-cloud-download"></i> COPIA DE SEGURIDAD </small></h1>
            </div>
    ...
    <a href="../modelo/descargar.php"><img src="../estilos/descarga.png" height="100px" width="300px"></a>
    </center>
